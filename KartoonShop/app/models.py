...
class Customer(models.Model):       #<------------OrederPlaced=customer-----------------------|
...
#                                                                        OrderPlaced=Product
class Product(models.Model): # <---------Cart=product-------------------|-------<|------|     |
...
#
    def __str__(self):#                                                                 |     |
        return str(self.id)#
#                                                                                       |     |
    """ function shows price of particular product in cart * quantity of that product """#    |
    @property#                                                                          |          
    def total_cost(self):#                                                              |     |
